...
bigger_word = big_word.insert(34,'wow').insert(37,'mom') # Use String concatenation to add "wow" and "mom" to big_word
...
puts sentence.gsubgsub(/A/, 'O').gsub(/a/, 'o')
...
# puts "supercalifragilisticexpialidocious".insert(0,'wow').insert(37,'mom') 
#
